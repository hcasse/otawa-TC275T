...
class BBTimer16E: public etime::EdgeTimeBuilder {
public:
	static p::declare reg;
	BBTimer16E(void): etime::EdgeTimeBuilder(reg) { }
...
p::declare BBTimer16E::reg = p::init("otawa::tricore16::BBTimer16E", Version(1, 0, 0))
